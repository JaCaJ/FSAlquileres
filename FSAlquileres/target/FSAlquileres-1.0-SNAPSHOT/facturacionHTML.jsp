            ...
            <div class="card gradient-dark-grey">
                ...
                <div class="card-body">
                    <div class="row">
                                    ...
                                    <div class="row gutters">
                                                ...
                                                <form action="#" id="form" method="POST" role="form">
                                                    ...
                                                    <div class="mb-3 control-dark">
                                                        ...
                                                        <input class="form-control datepicker-input input-group" 
                                                               type="date" name="ped_fecha_retiro" id="ped_fecha_retiro">
                                                    </div>
                                                    <div class="mb-3 control-dark">
                                        ...
                                        <div class="col-sm-6 col-12">
                                            <div class="mb-3 control-dark">
                                                ...
                                                <input class="form-control datepicker-input input-group" 
                                                       type="date" name="ped_fecha_entrega" id="ped_fecha_entrega">
                                            </div>
                        ...
                        <div class="col-sm-12 col-12">
                            <div class="product-block">
                                <div class="product-title">DETALLE VENTA</div>
                                <div class="product-body">
                                    <div class="col-sm-12 col-12">
                                        <div class="card gradient-dark-grey">
                                            <div class="card-body">
                        ...
                        <div class="product-title"><label class="form-label text-start">MONTO TOTAL:</label> <div id="lbltotal" name="lbltotal"></div></div>
                        <div class="col-sm-12 col-12">
                            <div class="custom-btn-group flex-end">
