        ...
        <div class="col-sm-12 col-12">
            <div class="card gradient-dark-grey">
                <div class="card-header">
                    <div class="card-title">INFORME DE FACTURAS</div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12 col-12">
                                ...
                                <div class="product-body">
                                    <div class="row gutters">
                                                ...
                                                <form action="#" id="form" method="POST" role="form">
                                                    ...
                                                    <div class="mb-3 control-dark">
                                                        <div class="form-check form-switch">
                                                            <label class="form-label">PEDIDOS CANCELADOS
                                                                <span class="text-red">*</span></label> 
                                                            <input class="form-check-input" type="checkbox" id="pedidosC" name="pedidosC"/>
                                                        </div>
                                                    </div>
                                                    -->
                                                    <!-- Field wrapper end -->
                                        ...
                                        <div class="col-sm-3 col-3">
                                            ...
                                            <!--  <div class="mb-3 control-dark">
                                                <div class="form-check form-switch">
                                                    <label class="form-label">PEDIDOS ANULADOS
                                                        <span class="text-red">*</span></label> 
                                                    <input class="form-check-input" type="checkbox" id="pedidos_anulados" name="pedidos_anulados" />
                                                </div>
...
<!--<!-- añadidos por mí -->
<script src="js/deFactura.js"></script>
<script>
